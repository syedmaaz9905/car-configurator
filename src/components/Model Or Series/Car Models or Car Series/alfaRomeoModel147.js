...
const AlfaRomeoModel147 = () => {
  ...
  const goToAlfaRomeo14720012005 = () => {
      ...
      <div className='flex flex-wrap justify-center gap-8'>
        {alfaRomeoModels.map((brand, index) => (
          <div
            ...
            onClick={goToAlfaRomeo14720012005}
          >
            <img
              src={brand.logo}
              alt={`${brand.name} Logo`}
...
export default AlfaRomeoModel147